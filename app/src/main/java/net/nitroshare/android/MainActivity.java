...
import net.nitroshare.android.Hotpost.ApManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            window.setStatusBarColor(ContextCompat.getColor(MainActivity.this, R.color.Error));
    ...
    public class CardHandler {
        ...
        public void setDataSharing() {
            ...
            shareData_card.setCardBackgroundColor(getResources().getColor(R.color.colorAccent));
        ...
        public void setDataReceiving() {
            ...
            receiveData_card.setCardBackgroundColor(getResources().getColor(R.color.colorAccent));
        ...
        public void normalize() {
            ...
            shareData_card.animate()
                    ...
                    .setListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            shareData_card.setCardBackgroundColor(getResources().getColor(R.color.colorIconDark));
                            shareData_text.setTypeface(null, Typeface.NORMAL);
            ...
            receiveData_card.animate()
                    ...
                    .setListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            mainLayout.setGravity(Gravity.NO_GRAVITY);
                            receiveData_card.setCardBackgroundColor(getResources().getColor(R.color.colorIconDark));
                            receiveData_text.setTypeface(null, Typeface.NORMAL);
